...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : .Colton`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : .Colton ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`$bc Bot`,"http://twitch.tv/Death Shop")
...
client.login("NzQyNDI3NjA3MTMxMjI2MjM4.XzF9lw.6D34KDdc0uW2cGUje_zrN_dcW6c");
